		...
		compile: function (element, attrs) {
			...
			return function (scope, element, atributos) {
				...
				var controls = angular.element('<div class="pagination-panel">'+
					'<button class="mui-btn mui-btn--small mui-btn--primary mui-btn--flat" title="Anterior" id="ng-pag-custom" ng-click="'+registro.getBeforeNotation()+'()" type="button"'+
					'ng-disabled="'+registro.getCurrentNotation()+'<=0"><i class="fas fa-chevron-left"></i></button>'+

					'<small class="indicator">{{'+registro.getCurrentNotation()+'+1}} / {{'+registro.getPagesNotation()+'}}</small>'+

					'<button class="mui-btn mui-btn--small mui-btn--primary mui-btn--flat" title="Siguiente" id="ng-pag-custom" ng-click="'+registro.getNextNotation()+'()" type="button"'+
					'ng-disabled="'+registro.getCurrentNotation()+'>=('+registro.getDataLengthNotation()+'/'+registro.getSizeNotation()+')-1"><i class="fas fa-chevron-right"></i></button>'+
				'</div>');
