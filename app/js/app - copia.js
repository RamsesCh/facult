...
var app3 = angular.module('App3', ['ngStorage']);
    ...
    /* factory de catalogos*/
    /* controllers*/
    app3.controller('gac', function ($scope, $window, $q, $http, $rootScope, $location, $sessionStorage) {
...
//botton continuar//
    ...
    app.controller('MainCtrl', function ($scope, $rootScope, $log, $http, $routeParams, $location, $route, $q, $window, $timeout) {
        ...
        //console.log(facults)
        var salida = [];
        if($scope.userActivo.perfil == 'ADMIN' || $scope.userActivo.perfil == 'GOD'){
...
153,
    ...
    app.controller('InsertCtrl', function ($scope, $rootScope, $log, $http, $routeParams, $location, $route, Upload, $timeout, $window) {
                ...
                .success(function (data, status, headers, config) {
                    ...
                    angular.forEach($scope.picFiles, function(file) {
                        ...
                        file.upload.then(function (response) {
                            $timeout(function () {
                                console.log("se han subido los archivos")
    ...
    app.controller('estadistCtrl', function($scope, $http, $rootScope, $parse, ngDialog){
        ...
        $scope.clickToOpen = function (report) {
            //console.log(report)
            ngDialog.open({
                template: '<h4><i class="fas fa-chart-pie"></i> '+ report.titulo +'</h4><iframe class="reports-frame" src='+ report.url +'></iframe>',
                plain: true,
                closeByDocument: false,
                className: 'ngdialog-theme-default',
                width: '95%',
